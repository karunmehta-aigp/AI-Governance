# NIST AI RMF Mapping — Halcyon Financial Group
...
### HFG-AI-001 · CreditLens Decisioning (High Risk)
...
### HFG-AI-002 · ApplicantIQ Screener (High Risk)
...
### HFG-AI-003 · SentinelAML Monitor (High Risk — conservative)
...
### HFG-AI-004 · VoicePrint Authenticator (High Risk)
...
### HFG-AI-005 · Halo Virtual Assistant (Limited Risk)
...
### HFG-AI-006 · AdGen Creative Studio (Limited Risk)
...
### HFG-AI-007 · WorkforcePulse Monitor (Limited Risk)

| RMF Function | Current State | Gaps | Maturity |
|---|---|---|---|
| GOVERN | VP of Operations accountable. People Analytics team manages the system internally. | No AI governance policy reference; no formal sign-off on individual-level flagging feature. | 2 |
...
### HFG-AI-008 · PortfolioLens Analytics (Minimal Risk)
...
### HFG-AI-009 · ComplianceScout (Minimal Risk)
...
### HFG-AI-010 · ShiftSync Scheduler (Minimal Risk — pilot)
...
**Overall Maturity: 1.0 (Initial)**
**Priority Actions:** Define explicit governance gate criteria, including reclassification triggers, before any expansion beyond the Irish pilot; complete risk mapping; establish a fairness review of roster recommendations prior to wider rollout.

## Portfolio-Level Summary

| System | EU AI Act Tier | RMF Maturity | Action Priority |
|---|---|---|---|
| HFG-AI-001 CreditLens Decisioning | High Risk | 1.75 | Critical |
| HFG-AI-002 ApplicantIQ Screener | High Risk | 1.0 | Critical — immediate |
| HFG-AI-003 SentinelAML Monitor | High Risk (conservative) | 2.0 | High |
| HFG-AI-004 VoicePrint Authenticator | High Risk | 1.0 | Critical |
| HFG-AI-005 Halo Virtual Assistant | Limited Risk | 3.0 | Low |
| HFG-AI-006 AdGen Creative Studio | Limited Risk | 1.75 | Medium |
| HFG-AI-007 WorkforcePulse Monitor | Limited Risk | 2.0 | Medium |
| HFG-AI-008 PortfolioLens Analytics | Minimal Risk | 3.0 | Monitor |
| HFG-AI-009 ComplianceScout | Minimal Risk | 3.0 | Monitor |
| HFG-AI-010 ShiftSync Scheduler | Minimal Risk (pilot) | 1.0 | Monitor — reassess on scope change |

**Portfolio risk concentration:** Four of Halcyon Financial Group's ten AI systems are classified High Risk under the EU AI Act, and three of those four (CreditLens, ApplicantIQ, VoicePrint) are in active production with RMF maturity scores at or below 1.75 — meaning the highest-consequence systems in the portfolio are also the least governed. This is the inverse of where governance effort should be concentrated, and it represents material regulatory exposure ahead of supervisory scrutiny. A remediation programme prioritising these three systems should be initiated immediately, with SentinelAML's provisional classification resolved by legal counsel in parallel.
