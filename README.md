...
**Project 12 — Agentic AI Governance** is a hybrid of the two approaches above. Like Projects 1–5, it runs specific narratives, now spanning four contrasting case studies: a fictional three-agent expense-reimbursement pipeline (`ORG-AI-011`) walked end-to-end through governance, deployment, and one real incident; a loan pre-approval agent (`ORG-AI-012`), deliberately chosen to show how regulation-driven risk (credit decisioning is high-risk by classification under the EU AI Act regardless of autonomy) differs from the autonomy-driven risk that governs the first case study; an agentic investment management system (`ORG-AI-013`), a 15-component, 9-phase multi-agent chain that introduces orchestration risks — A2A handoffs, confused-deputy risk, segregation of duties — the earlier single-pipeline case studies don't test; and an investment research agent (`ORG-AI-014`), a single GenAI+RAG system that shifts the governance question away from orchestration entirely and onto factuality, hallucination risk, and SEC/FINRA fair-and-balanced obligations. Like Projects 6–11, it also ships as a fully reusable, industry-agnostic toolkit: a governance charter, a 16-control library, a compliance crosswalk spanning six frameworks (NIST AI RMF, EU AI Act, ISO/IEC 42001, OWASP LLM Top 10, MITRE ATLAS, GDPR), eight fillable templates, and five completed worked examples. It's the newest and most actively evolving project in the portfolio, because agentic AI governance itself is still an unresolved, live regulatory conversation.
...
| 12 | [Agentic AI Governance](./project-12-agentic-ai-governance/) | EU AI Act · NIST AI RMF · ISO/IEC 42001 · OWASP LLM Top 10 · MITRE ATLAS · GDPR | Governance charter, 16-control library, 4 end-to-end agent case studies, 8 templates, 5 worked examples |
