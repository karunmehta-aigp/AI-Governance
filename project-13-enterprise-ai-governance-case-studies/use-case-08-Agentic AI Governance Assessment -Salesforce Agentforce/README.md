...
**Assessment outcome:** **From the deployer perspective:** Public certification, the Trust Layer, and supporting documentation provide useful inputs to vendor due diligence, while action-level governance — permissions, boundaries, human oversight, and monitoring — remains the deploying organization's responsibility.
