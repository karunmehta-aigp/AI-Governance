...
**A note on subject type:** Use Cases 01–06 analyse a fictional organisation and fictional AI systems, built to illustrate governance methodology in depth without referencing any real company. Use Cases 07 and 08 are different by design — they are independent, public-evidence assessments of real, named products, demonstrating the same frameworks applied externally, the way a vendor risk reviewer or procurement team would. The **Subject** column below makes this distinction explicit for every entry.
...
| 7 | [AI Governance Assessment — Microsoft 365 Copilot](./use-case-07-ai-governance-assessment-copilot/README.md) | Enterprise Productivity / Cross-Sector | **Real, named product** — independent public-evidence review, not affiliated with or reviewed by Microsoft | No — single external product assessment | NIST AI RMF, EU AI Act, ISO/IEC 42001 |
| 8 | [Agentic AI Governance Assessment — Salesforce Agentforce](./use-case-08-Agentic%20AI%20Governance%20Assessment%20-Salesforce%20Agentforce/README.md) | Enterprise Agentic AI / Cross-Sector | **Real, named product** — independent public-evidence review, not affiliated with or reviewed by Salesforce | Yes — autonomous, action-taking agentic platform | NIST AI RMF, EU AI Act, ISO/IEC 42001 |

---

*Use Cases 01–06 are illustrative examples created for professional learning and portfolio development. Metrics and scenarios are illustrative and not production data. Use Cases 07 and 08 are independent assessments based solely on publicly available materials about real products; they are not a comprehensive account of those products' internal governance, and time-sensitive facts within them should be independently re-verified before reliance. Nothing in this repository is legal or regulatory advice.*
